...
- `d3d12.dll` 由 `ReShade64.dll` 重命名而来，这是 ReShade 的核心组件，也是入口，把该文件改名或删除即可禁用 ReShade
- `renodx-endfield.addon64` 这是插件作者专门适配终末地HDR制作的 ReShade 插件
- `ReShade.ini` ReShade 配置文件，运行一次后生成
...
![](Endfield_2026-03-07-22_Overlay.png)
...
![](/assets/images/22112958.avif)

<img decoding="async" loading="lazy" src="22112958.avif">
