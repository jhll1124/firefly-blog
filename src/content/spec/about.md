...
<div class="about-wrap">
  <div class="avatar">
    <img src="/favicon/136675725_p0.png" alt="avatar">
  </div>
  <div class="profile">
...
本网站是一个基于 [Fuwari](https://github.com/saicaca/fuwari) 框架构建的静态网站，所有源代码采用 MIT 协议开源在 GitHub 上。

::github{repo="saicaca/fuwari"}

# 隐私政策

我们非常重视您的隐私。本网站是完全静态的，不主动收集或存储任何用户数据，不使用 cookies，不包含第三方跟踪或分析服务。所有用户偏好设置（如主题选择）均保存在本地浏览器中。托管服务商可能保留标准的访问日志（IP 地址、浏览器类型等），但这并非本站主动收集。
